...
def load_data():
  ...
  ys = []
  for i in range(1, 6):
    filename = '/Users/dvenka002c/TECHNICAL/ML/DATASETS/cifar-10-batches-py/data_batch_' + str(i)
  ...
  x_test, y_test = load_CIFAR10_batch('/Users/dvenka002c/TECHNICAL/ML/DATASETS/cifar-10-batches-py/test_batch')
